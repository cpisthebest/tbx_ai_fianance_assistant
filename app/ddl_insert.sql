...
CREATE INDEX idx_account_entity
...
CREATE INDEX idx_transaction_utr
ON transactions(utr_number);

CREATE INDEX idx_transaction_reference
ON transactions(transaction_reference_id);
...
CREATE INDEX transaction_embedding_hnsw
ON transaction_embedding
USING hnsw
